  ...
  return (
    <>
      <div className="mx-auto max-w-270">
        <Breadcrumb pageName="Configuracion" />
                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="fullName"
                          id="fullName"
                          placeholder="Samir Lora"
                          defaultValue="Samir Lora"
                        />
                      </div>
                    </div>
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="+57 300 243 7865"
                        defaultValue="+57 300 243 7865"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="samirtest@gmail.com"
                        defaultValue="samirtest@gmail.com"
                      />
                    </div>
                  </div>
